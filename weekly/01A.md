...
- How will web frameworks like [ReactJS](https://reactjs.org/), "age"? Probably not well!
  - in 10 years (or even 5), will a typical React app still run in a web browser?
    - *Probably NOT*
  - And if it didn't, how easy would it be to edit the [JSX](https://reactjs.org/docs/introducing-jsx.html) code (JSX=proprietary web components) and republish it?

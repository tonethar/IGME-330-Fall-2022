...
- Have the following sub-headings on your page (the same as project 1)
  ...
  - **RESOURCES UTILIZED**:
    - cite any and all resources you used on this project, the specific link, including:
      - IGME-330 HW assignments that were utilized such as *Cage Clicker* or the "AV" HW assignments
      - fonts and images
...
- Explore **one** of the *themes* that we covered in class:
  ...
  - **Audio Visualizer?**
    ...
    - See [Project 2 Overview & Tips - AV Tips](p2-overview-and-tips.md#av-tips)
  <a id="game" />
  ...
  - **Game?**
    ...
    - See [Project 2 Overview & Tips - Game Tips](p2-overview-and-tips.md#game-tips)

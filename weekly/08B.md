...
- Take notes on the things you missed - you will definitely see some of these questions on the final exam
- If you see a discrepancy with your midterm exam grade (incorrectly marked off a question, calculated grade wrong etc), get with me after class and let me know what you feel the issue is, and I will then re-grade your exam
...
- Discuss [Project 1 - Final Requirements](../projects/p1-final.md)
  - **Due Dates**:
    - *Project 1 Final* - the due date has been pushed back from Sunday night 10/16 to Wednesday night 10/19. You MUST submit to this dropbox.
    - *Project 1 - LAST CHANCE* - Saturday night 10/22
  - **Project Demos**
  ...
  - **Firebase**
    ...
    - it's easier do you than you might think - and there's already a short video that walks through it [Week 8A - More Firebase - creating a likes counter for Dog Names](08A.md/#ii-more-firebase---creating-a-likes-counter-for-dog-names)
...
- The HW assignments covered quite a bit, but there's still a little bit more about Firebase:
 - `get(path)`
...
## V. Project 1 Helpers - Creating a "likes" counter and more

- [Project 1 "Helpers"](../projects/p1-helpers.md)
